            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="bg-white p-4 rounded mb-4 shadow ">
                        <h5>Call Us</h5>
                        <a href="tel: +63912346789" class="d-inline-block mb-2 text-decoration-none text-dark ">
                            <i class="bi bi-telephone-fill"></i> +63912346789 <br>
                            <i class="bi bi-telephone-fill"></i> +63912346789
                        </a>
                    </div>
                    <div class="bg-white p-4 rounded mb-4 shadow ">
                        <h5>Follow Us</h5>
                        <a href="#" class="d-inline-block mb-2 text-decoration-none text-dark ">
                            <i class="bi bi-facebook text-primary"></i>  Facebook <br>
                            <i class="bi bi-instagram text-danger"></i>  Instagram <br>
                            <i class="bi bi-twitter text-primary"></i>  Twitter <br>
                            <i class="bi bi-tiktok"></i>  Tiktok <br>
                        </a>
                    </div>
                </div>
            </div>
